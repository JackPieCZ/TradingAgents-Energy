...
@tool
def get_wind_forecast(delivery_date: str, market_area: str = "CZ") -> str:
...
@tool
def get_solar_forecast(delivery_date: str, market_area: str = "CZ") -> str:
...
@tool
def get_generation_forecast(delivery_date: str, market_area: str = "CZ") -> str:
...
@tool
def get_forecast_updates(delivery_date: str, market_area: str = "CZ") -> str:
...
@tool
def get_weather_forecast(delivery_date: str, market_area: str = "CZ") -> str:
...
@tool
def get_historical_forecast(delivery_date: str, market_area: str = "CZ") -> str:
