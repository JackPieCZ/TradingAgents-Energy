...
@tool
def get_day_ahead_prices(delivery_date: str, market_area: str = "CZ") -> str:
...
@tool
def get_intraday_prices(delivery_date: str, market_area: str = "CZ") -> str:
...
@tool
def get_intraday_auction_prices(delivery_date: str, market_area: str = "CZ") -> str:
